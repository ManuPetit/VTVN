...
<title>Erreur 500 sur www.vieuxnyons.com</title>
<style type="text/css">
div#enteteCentre {
	width:439px;
	height:280px;
...
<div id="conteneur">
	...
	<div id="longHaut">
      <h2>500 - Erreur de serveur interne</h2>
    </div>
	<div id="longMilieu">
<p>
Le serveur Web n'est pas en mesure de traiter la requête. Veuillez réessayer ultérieurement.<br  /><br  />
