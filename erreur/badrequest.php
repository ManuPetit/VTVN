...
<title>Erreur 400 sur www.vieuxnyons.com</title>
<style type="text/css">
div#enteteCentre {
	width:439px;
	height:280px;
...
<div id="conteneur">
	...
	<div id="longHaut">
      <h2>Erreur HTTP 400 - Mauvaise demande</h2>
    </div>
	<div id="longMilieu">
<p>
En raison d'une syntaxe erronée, la demande n'a pas pu être comprise par le serveur.<br  /><Br  />
