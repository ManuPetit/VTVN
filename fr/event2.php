...
<p><span class="sstitre">Modifier un &eacute;v&eacute;nement</span></p><br />
<p>Selectionnez dans la liste ci-dessous, l'événement que vous souhaitez modifier, en cliquant son nom :</p><p><br  /></p>
...
<table border="0" cellpadding="2" width="100%">
	...
	<?php
		...
		for ($i=0; $i<=$nbr_ev; $i++) {//on passe en revue chaque evenement
			echo '<tr><td align="left" class="photo"><a class="event" href="eventmod.php?eveid=' . $ev_id[$i] . '">';
